...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		...
		#"vcs_modified 9 255"
		#"vcs_others 245 0"
		"tmux_session_info 235 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		"vcs_others 235 122 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"vcs_modified 235 122 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"vcs_staged 235 122 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"vcs_compare 235 122 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"vcs_branch 235 122 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"pwd 235 6 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"hostname 235 211 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"wan_ip 235 12 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"lan_ip 235 12 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time 235 215 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"utc_time 235 215 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
	)
fi
